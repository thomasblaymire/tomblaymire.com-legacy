...
})(["color:", ";margin-top:7rem;width:100%;position:absolute;bottom:20rem;@media (min-width:480px){width:70%;}.intro{font-size:7vmin;margin:0;}.description{font-size:1.6rem;line-height:2.6rem;font-weight:300;@media (min-width:480px){line-height:38px;font-size:3.5vmin;font-weight:300;min-width:80%;}}"], function (props) {
...
//# sourceMappingURL=index.js.0d15c2ab5bad3b34bee2.hot-update.js.map