...
})(["color:", ";margin-top:3.5rem;width:100%;@media (min-width:480px){width:70%;}.intro{font-size:7vmin;margin:0;}.description{font-size:1.6rem;line-height:2.6rem;font-weight:300;@media (min-width:480px){line-height:38px;font-size:3.5vmin;line-height:24px;font-weight:300;width:80%;}}"], function (props) {
...
//# sourceMappingURL=index.js.67886bf1746fbc3c8608.hot-update.js.map