...
})(["margin-top:4rem;.portfolio-image{width:100%;box-shadow:0 0 15px rgba(0,0,0,0.08),0 0 4px rgba(0,0,0,0.05);position:relative;height:auto;@media (min-width:768px){height:330px;}&:hover{cursor:pointer;}}a{text-decoration:none;font-weight:normal;}"]);
...
})([".portfolio-title{font-family:", ";letter-spacing:-0.02em;font-weight:700;font-style:normal;font-size:2rem;margin:0;color:", ";cursor:pointer;}ul{list-style-type:none;padding:0;display:flex;flex-wrap:wrap;margin-top:0.5rem;}li{color:#474747;margin-right:1rem;background:", ";border-radius:5px;padding:0 1rem;margin-bottom:1rem;cursor:initial;font-size:1.2rem;}"], function (props) {
...
//# sourceMappingURL=portfolio.js.d868cd092062524c37db.hot-update.js.map