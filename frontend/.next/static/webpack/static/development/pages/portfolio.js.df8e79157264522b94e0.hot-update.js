...
})(["display:flex;align-items:center;justify-content:center;flex-wrap:wrap;display:none;a,button{display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:1.7rem;background:none;font-family:", ";letter-spacing:0.05em;font-weight:500;border:0;cursor:pointer;color:", ";padding:25px 15px;&:hover{color:#3eaca8;}}@media (min-width:950px){display:block;}.show{a{display:block;opacity:1;visibility:visible;}}"], function (props) {
...
//# sourceMappingURL=portfolio.js.df8e79157264522b94e0.hot-update.js.map