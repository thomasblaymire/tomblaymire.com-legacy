...
})(["display:flex;align-items:center;justify-content:center;a,button{display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:1.7rem;background:none;font-family:", ";letter-spacing:0.05em;font-weight:500;border:0;cursor:pointer;color:", ";padding:25px 15px;&:hover{color:#3eaca8;}}a{@media (min-width:950px){opacity:0;visibility:hidden;}}.show{* a{opacity:1;visibility:visible;}}"], function (props) {
...
//# sourceMappingURL=index.js.088acb852e08a87d1a0e.hot-update.js.map