...
})(["background-image:url(", ");background-size:cover;min-height:70vh;background-repeat:no-repeat;background-position:center center;background-attachment:fixed;position:relative;background-position-x:auto;@media (min-width:480px){min-height:100vh;background-position-x:-500px;}"], _static_me_jpg__WEBPACK_IMPORTED_MODULE_3___default.a);
...
//# sourceMappingURL=index.js.67dc231a6e7e66a92ce5.hot-update.js.map