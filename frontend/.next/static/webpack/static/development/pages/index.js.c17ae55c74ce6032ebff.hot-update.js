...
})(["color:", ";width:100%;position:absolute;bottom:25rem;@media (min-width:480px){width:60%;bottom:15rem;}.intro{font-size:7vmin;margin:0;}.description{font-size:1.6rem;line-height:2.6rem;font-weight:300;@media (min-width:480px){line-height:4.5rem;font-size:3.5vmin;font-weight:300;min-width:80%;}}"], function (props) {
...
//# sourceMappingURL=index.js.c17ae55c74ce6032ebff.hot-update.js.map