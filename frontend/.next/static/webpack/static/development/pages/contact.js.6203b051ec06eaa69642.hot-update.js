...
})([".links-button{width:25px;position:relative;}.social-menu{background:black;height:150px;position:absolute;padding:5px 0;margin-left:-5px;visibility:hidden;opacity:0;transition:visibility 0s ease 0s,opacity 0.5s ease;-webkit-transition:visibility 0s ease 0s,opacity 0.5s ease;z-index:2;}"]);
  ...
  _createClass(Nav, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NavStyles, {
        ...
        __self: this
      })), this.state.socialMenu && react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement("div", {
...
//# sourceMappingURL=contact.js.6203b051ec06eaa69642.hot-update.js.map