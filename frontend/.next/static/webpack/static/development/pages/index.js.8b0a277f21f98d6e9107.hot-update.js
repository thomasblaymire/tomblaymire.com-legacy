...
})(["color:", ";margin-top:7rem;width:100%;position:absolute;bottom:25rem;@media (min-width:480px){width:70%;}.intro{font-size:7vmin;margin:0;}.description{font-size:1.6rem;line-height:2.6rem;font-weight:300;@media (min-width:480px){line-height:38px;font-size:3.5vmin;font-weight:300;min-width:80%;}}"], function (props) {
...
//# sourceMappingURL=index.js.8b0a277f21f98d6e9107.hot-update.js.map