...
})(["display:flex;align-items:center;justify-content:center;a,button{display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:1.7rem;background:none;font-family:", ";letter-spacing:0.05em;font-weight:500;border:0;cursor:pointer;color:", ";padding:25px 15px;&:hover{color:#3eaca8;}}a{@media (max-width:950px){opacity:0;visibility:hidden;}}.show{opacity:1;visibility:visible;}"], function (props) {
  ...
  _createClass(Nav, [{
    ...
    value: function render() {
      return react__WEBPACK_IMPORTED_MODULE_1___default.a.createElement(NavStyles, {
        ...
        className: 'btn-group pull-right ' + (this.state.mobileNav && 'show'),
        __source: {
          fileName: _jsxFileName,
          lineNumber: 121
        },
...
//# sourceMappingURL=portfolio-innovation.js.0d67dfdfdc34a1c3e300.hot-update.js.map