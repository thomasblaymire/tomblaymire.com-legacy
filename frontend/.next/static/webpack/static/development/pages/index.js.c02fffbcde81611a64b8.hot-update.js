...
})(["width:100%;box-shadow:0 0 15px rgba(0,0,0,0.08),0 0 4px rgba(0,0,0,0.05);position:relative;height:auto;@media (min-width:768px){height:350px;}@media (min-width:992px){background-color:", ";}&:hover{cursor:pointer;}"], function (props) {
  return props.customStyle ? "red" : "blue";
});
...
//# sourceMappingURL=index.js.c02fffbcde81611a64b8.hot-update.js.map