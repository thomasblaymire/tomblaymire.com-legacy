		...
		<div>
			...
			<PageContent>
				<div className="container">
					<Portfolio>
						<div class="row">
							<img src={portfolioPad} class="screenshot" alt="Product Analysis Homepage" />
							<div class="content">
								<h3 class="heading">Project Requirements</h3>
								<p class="description">
									Hermes Depot managers required a bespoke dashboard for the upcoming Christmas perioud so they could
									easily see and analyse the volume of parcels expected within the network throughout the day.
								</p>
								<p className="description">
									Having a clear user interface with responsive live updating graphs was essential, the graphs also
									needed to be responsive out of the box as managers used various different devices from iPads to
									Samsung mobiles.
								</p>
							</div>
						</div>
						<div class="row">
							<img src={padLogin} class="screenshot" alt="Product Analysis Login" />
							<div class="content">
						...
						<div class="row">
							<img src={padStats} class="screenshot" alt="Product Analysis Technology" />
							<div class="content">
