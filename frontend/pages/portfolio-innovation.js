          ...
          <Portfolio>
            <div class="row">
              ...
              <div class="content">
                ...
                <p class="description">
                  Hermes Innovation required a new website to help develop their
                  brand awareness and gather project feedback with the
                  community.
                </p>
                <p className="description">
                  I built the entire new front-end from scratch whilst working
                  alongside designers, testers and project managers.
                </p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="content">
                ...
                <p class="description">
                  A focus on speed, maintainability and performance was
                  essential when gathering the initial requirements. The site
                  was built with:{" "}
                </p>
                <ul>
                  <li>React</li>
            ...
            <div class="row">
              ...
              <div class="content">
                ...
                <p class="description">
                  The website is built with a range of different features
                  allowing a user to submit innovation ideas for the team to
                  respond to, approve and maintain.
                </p>
                <p class="description">
                  Overall the project was a huge success internally and has
                  given the innovation team a solid brand presence online.
                </p>
              </div>
            </div>
          </Portfolio>
