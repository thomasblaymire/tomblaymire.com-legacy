          ...
          <Portfolio>
            <div class="row">
              ...
              <div class="content">
                ...
                <p class="description">
                  I was heavily involved with the creation of the main sales
                  webste with the primary goal to increase sales and allow for
                  customers to easily get in touch for enquiries and support
                  queries.{" "}
                </p>
              </div>
            </div>
            <div class="row">
              ...
              <div class="content">
                ...
                <p class="description">
                  Bespoke website creation with the ability for patients to
                  easily order thier repeat prescriptions and book appointments
                  online via their local practice website.
                </p>
                <p class="description">
                  Websites were built with accessibility as a first priority due
                  to patients with various disabilities and adhered to WCAG 2.0
                  guidelines.
                </p>
                <ul>
                  <li>Angular JS</li>
