...
})(["height:auto;min-height:100vh;.heading{font-family:", ";letter-spacing:-0.02em;font-weight:700;font-style:normal;color:", ";font-size:4.2rem;margin:0;}.sub-heading{font-family:", ";font-size:2rem;color:#474747;margin:0;line-height:3rem;}.container{max-width:1170px;margin-right:auto;margin-left:auto;padding:0px 15px;padding:0px 15px;@media (min-width:568px){width:550px;}@media (min-width:992px){width:1170px;}@media (min-width:1200px){width:1170px;}}"], function (props) {
...
//# sourceMappingURL=about.js.81f7d4d94c19e28dcf47.hot-update.js.map