...
})(["display:flex;align-items:center;justify-content:center;a,button{display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:1.7rem;background:none;font-family:", ";letter-spacing:0.05em;font-weight:500;border:0;cursor:pointer;color:", ";padding:25px 15px;&:hover{color:#3eaca8;}@media (max-width:950px){opacity:0;visibility:hidden;}}"], function (props) {
...
//# sourceMappingURL=index.js.84e856c80c09f679457f.hot-update.js.map