...
})(["margin:0;padding:0;display:flex;justify-content:flex-end;font-size:2rem;.show{opacity:1;visibility:visible;transition:.2s;position:absolute;left:0;background:#100e17;z-index:1;display:grid;width:100%;height:calc(100vh - var(--nav-height));height:100%;}"]);
...
})(["background:0 0;border:0;cursor:pointer;@media(min-width:900px){display:block;}svg{width:50px;}"]);
...
//# sourceMappingURL=index.js.0d6aa377135d3942dd54.hot-update.js.map