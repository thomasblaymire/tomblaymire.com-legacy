...
})(["background-color:#05af43;font-size:1.6rem;padding:14px 30px;color:#fff;border:solid 2px #05af43;border-radius:5px;font-family:'Poppins',sans-serif;cursor:pointer;width:200px;&:hover{background-color:#05da53;border:solid 2px #05da53;}"]);
...
})(["background-color:transparent;font-size:1.6rem;padding:14px 30px;color:#fff;border:solid 2px white;border-radius:5px;font-family:'Poppins',sans-serif;cursor:pointer;width:200px;&:hover{color:red;background-color:#fff;}"]);
...
//# sourceMappingURL=index.js.be5c53ce5816758a655f.hot-update.js.map