...
})(["display:none;@media (max-width:950px){display:flex;a,button{display:flex;align-items:center;position:relative;text-transform:uppercase;font-size:1.7rem;background:none;font-family:", ";letter-spacing:0.05em;font-weight:500;border:0;cursor:pointer;color:", ";padding:25px 15px;&:hover{color:#3eaca8;}}}"], function (props) {
...
//# sourceMappingURL=portfolio-careers.js.7fd6bc28e3564d9d3512.hot-update.js.map